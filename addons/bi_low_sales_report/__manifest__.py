...
# Part of BrowseInfo. See LICENSE file for full copyright and licensing details.
{
    ...
    "description": """ 
        ...
        Lower Sales Report Odoo App helps users to take out reports of poorly performing products. User can configure default criteria for product quantity and amount to print low sales report. User have option to select report type like product, product variants and product category between any of the date range to print low sales report. User can print low sales report in PDF and XLS format and also display low sales report analysis in pivot view.
